...
try {
  ...
  report.generatedFiles = [
    ...
    join(targetDir, '.cursor', 'skills', 'ultracode', 'SKILL.md'),
    join(targetDir, '.cursor', 'skills', 'ultracode', 'scripts', 'daemon-bridge.js'),
    join(targetDir, '.cursor', 'agents', 'odw-orchestrator.md'),
    join(home, '.cursor', 'extensions', 'open-dynamic-workflows.odw-vscode-0.1.0', 'package.json'),
    join(home, '.cursor', 'extensions', 'open-dynamic-workflows.odw-vscode-0.1.0', 'extension.js'),
    ...
    join(targetDir, '.agents', 'skills', 'ultracode', 'SKILL.md'),
    ...
    join(home, '.codex', 'plugins', 'odw', 'skills', 'ultracode', 'SKILL.md'),
    join(home, '.codex', 'plugins', 'odw', 'skills', 'ultracode', 'scripts', 'daemon-bridge.js'),
    join(home, '.agents', 'plugins', 'marketplace.json'),
    join(home, '.agents', 'skills', 'odw', 'SKILL.md'),
    join(home, '.agents', 'skills', 'ultracode', 'SKILL.md'),
    join(home, '.agents', 'skills', 'ultracode', 'scripts', 'daemon-bridge.js'),
    ...
    join(targetDir, '.kimi', 'skills', 'ultracode', 'SKILL.md'),
    ...
    join(home, '.gemini', 'config', 'plugins', 'odw', 'skills', 'ultracode', 'SKILL.md'),
    join(home, '.gemini', 'config', 'plugins', 'odw', 'skills', 'ultracode', 'scripts', 'daemon-bridge.js'),
    ...
    join(home, '.gemini', 'antigravity-cli', 'plugins', 'odw', 'skills', 'ultracode', 'SKILL.md'),
    join(home, '.gemini', 'antigravity-cli', 'plugins', 'odw', 'skills', 'ultracode', 'scripts', 'daemon-bridge.js'),
    ...
    join(targetDir, '.agents', 'plugins', 'odw', 'skills', 'ultracode', 'SKILL.md'),
    join(targetDir, '.agents', 'plugins', 'odw', 'skills', 'ultracode', 'scripts', 'daemon-bridge.js'),
    ...
    join(home, '.gemini', 'config', 'skills', 'ultracode', 'SKILL.md'),
    join(home, '.gemini', 'config', 'skills', 'ultracode', 'scripts', 'daemon-bridge.js'),
    join(home, '.gemini', 'skills', 'odw', 'SKILL.md'),
    join(home, '.gemini', 'skills', 'ultracode', 'SKILL.md'),
    join(home, '.gemini', 'skills', 'ultracode', 'scripts', 'daemon-bridge.js'),
