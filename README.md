...
odw-daemon integrate cursor       # writes MCP + rule + /odw skill + subagent + dashboard extension
...
packages/
  ...
  cursor-adapter/       Cursor Agent skill, subagent, MCP rule, and dashboard extension
